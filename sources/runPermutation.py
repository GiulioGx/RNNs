...
from datasets.PermutationTask import PermutationTask
...
vars_initializer = RNNVarsInitializer(
    ...
    W_rec_init=EigenInit(mean=1, std_dev=std_dev, seed=seed),
...
lr_rule = GradientClipping(lr_value=0.001, clip_thr=1, clip_style='l2')  # 0.01
