...
are computed, equation \ref{rnn_delta}. Time complexity is easily derived noticing that in the unfolded network there are $n \cdot T$ units, this
yields time complexity $\mathcal{O}(n\cdot T)$. Please see \cite{Williams90anefficient} for more details.
