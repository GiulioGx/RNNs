...
\begin{frame}{Effect of the simplex direction}
	...
	\begin{figure}
		\centering
	     \subfloat[][ Loss (in log scale) for the addition task during training]{\includegraphics[width= 0.5\textwidth]{compare_add_simplex_13.eps}\label{fig:compare_add_13}}
