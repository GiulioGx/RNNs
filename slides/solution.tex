...
\begin{frame}{Understanding the gradient structure}
	...
	\end{equation}
	where $\nabla L_{|t}$ is the gradient computed imagining to replicate all variables for each time step and taking the derivatives w.r.t the variables for the th-step 
\end{frame}
