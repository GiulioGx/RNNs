...
The definition takes into account the output for each temporal step, and, depending on the task at hand, it could be relevant or not to consider intermediate
