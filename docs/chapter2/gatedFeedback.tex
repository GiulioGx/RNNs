...
\begin{tikzpicture}[rnn_style]
  ...
  \node[gate] (g44)[left of=l4, node distance =4cm]{$g_{44}$};
  \node[gate] (g43)[left of=l3, node distance =4cm]{$g_{43}$};
  \node[gate] (g41)[left of=l1, node distance =4cm]{$g_{41}$};
  \node[gate] (g33)[right of=l3, node distance =4cm]{$g_{33}$};
  \node[gate] (g31)[right of=l1, node distance =4cm]{$g_{31}$};
  
      \path[->] (g44) edge[]   		(l4)
		(l4.north)  edge[bend right=50] (g44.north)
		(l4.north)  edge[bend right=90,distance=2.8cm] (g43.west)
		(g43) edge[]		(l3)
		(l4.north)  edge[bend right=110, distance =5cm] (g41.west)
		(g41) edge[]		(l1)
		(l3.east)  edge[bend left=50, anchor=east]	(g33)
		(g33) edge[]		(l3)
		(l3.east)  edge[bend left]	(g31.north)
		(g31) edge[]		(l1);

\end{tikzpicture}
\caption{Gated feedback architecture; only connections between layers trough gates are shown}
\label{fig:gated}
\end{figure}
