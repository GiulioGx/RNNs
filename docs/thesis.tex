...
\chapter{Literature review}
  ...
  \input{chapter2/hf}
  \input{chapter2/reservoir}
  \input{chapter2/nesterov}
  \input{chapter2/dropout}
\chapter{A new proposal}
  \input{chapter3/solution}
\chapter{Experiments}
  \label{ch:experiments}
  \input{chapter4/tasks} 
  \input{chapter4/muse}
  \input{chapter4/lupus}
 \chapter{Conclusion}
...
\label{app:tasks}
\input{synthetic_tasks_appendix/artificial_datasets}
